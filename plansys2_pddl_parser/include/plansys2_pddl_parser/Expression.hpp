...
public:
  ...
  explicit CompositeExpression(const std::string & c)
  : op(c) {}
...
public:
  ...
  explicit FunctionExpression(ParamCond * c)
  : fun(c)
  {
    constants.clear();
...
public:
  ...
  explicit ValueExpression(double v)
  : value(v) {}
...
public:
  ...
  explicit ParamExpression(int p)
  : param(p) {}
